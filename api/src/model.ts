...
export class MapParameters {
  ...
  /**
   * Define a default authentication behavior for the map.
   * When used, the user/profile are ignored.
   *
   */
  public genericAuthentication: { editMode: boolean } = { editMode: false };
